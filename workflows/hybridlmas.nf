...
include { hybridassembly_wf } from '../modules/assembly/hybridassembly.nf'
...
workflow HYBRIDLMAS {
    ...
    hybridassembly_wf(IN_fastq_raw, IN_ont_raw)

    mapping_wf(hybridassembly_wf.out.all_assemblies, 
    ...
    report_wf(preprocessing_wf.out.reads_info, 
            ...
            hybridassembly_wf.out.all_versions)
}
...
eval $pull_command"cimendes/canu:2.2"
eval $pull_command"cimendes/flye:2.9"
...
eval $pull_command"cimendes/ra:0.2.1"
eval $pull_command"cimendes/raven:1.8.0"
...
eval $pull_command"cimendes/wtdgb2:2.5"
